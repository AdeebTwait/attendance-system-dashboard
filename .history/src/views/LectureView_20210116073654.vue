                ...
                <template #inputs>
                    <div class="row">
                        <div class="col-lg-6 form-group">
                            ...
                            <select v-model="lecture.students" multiple  class="form-control" name="student" id="student">
                                <option v-for="student in students" :key="student._id" :value="student.name">{{student.name}}</option>
                            </select>
                        </div>
                    </div>      
                </template>
                <template #submit>
                    <button @click="addStudents" class="btn btn-success">Add</button>
                </template>
            </base-form>
        </div>
    </div>
