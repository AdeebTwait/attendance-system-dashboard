<template>
    ...
    <div>
        ...
        <base-form :title="`Hall ${hall.hallNumber}`" card_title="Hall Information">
            ...
            <template #submit>
                <button @click="saveHall" class="btn btn-success">Update</button>
            </template>
        </base-form>
    </div>
</template>
...
export default {
    ...
    methods: {
        async saveHall() {
            ...
            this.$notify({verticalAlign: 'bottom', horizontalAlign: 'right', message: `You have successfully edited the hall, ${this.hall.hallNumber}.`});
