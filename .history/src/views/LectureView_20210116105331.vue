...
export default {
    ...
    computed: {
        ...
        students(){
            return this.users.filter(user => user.type == 'Student' && !this.lecture.students.includes(user))
        },
        teachers(){
    ...
    methods: {
        ...
        async addStudent() {
            ...
            const newUser = {_id: this.newStudent._id, name: this.newStudent.name, universityID: this.newStudent.universityID};
